...
public class UtilsCase {
	private int state;
	private ImageButton imgBtn;
	private UtilsGrille grille;
	/*
	 * State : Pour le jeu : 0 = Inexistant 1 = Libre 2 = Bloqué par joueur 5 =
	 * Avec taupe Pour l'algo : 1 = Libre mais avec taupe 3 = Libre mais sans
	 * taupe 4 = Bloqué par l'algo
	 */
	...
	public UtilsCase(Activity parent, Context ctx) {
		this.state = 0;
		this.parent = parent;
		this.ctx = ctx;
	...
	public UtilsCase(int state, Activity parent, Context ctx) {
		this.state = state;
		this.parent = parent;
		this.ctx = ctx;
		this.animContainer = new ImageView(ctx);
	...
	public void setImgBtn(ImageButton i, UtilsGrille parent,
